    ...
    <>
      <div className="bg-[#131921] py-2 xl:px-8 flex items-center justify-around">
        ...
        <div className="flex justify-center ">
          <input className="bg-white w-50 sm:w-80 md:w-100 lg:w-150 xl:w-200 h-10 outline-none ps-5 rounded-tl-sm rounded-bl-sm border-none" type="text" placeholder="Search"
